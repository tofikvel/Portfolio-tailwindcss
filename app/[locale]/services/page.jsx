    ...
    <main>
      ...
      <section className="min-h-[calc(100svh-64px)] flex justify-center items-center px-6 py-24 mx-auto" id="why-work-with-me">
        <div className="max-w-6xl flex flex-col gap-12">
          <div className="flex flex-col items-center text-center gap-6 md:mb-12">
            <h1 className="text-3xl font-bold md:text-4xl">{t("wwwm-title")}</h1>
          ...
          <div className="flex flex-col gap-6 md:flex md:flex-row">
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4">{t("wwwm-1-title")}</h3>
            ...
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4">{t("wwwm-2-title")}</h3>
                <p className="text-md text-gray-500 max-w-lg md:text-lg">
                  {t("wwwm-2-subtitle")}
                </p>
              </div>
            ...
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4">{t("wwwm-3-title")}</h3>
                <p className="text-md text-gray-500 max-w-lg md:text-lg">
                  {t("wwwm-4-subtitle")}
                </p>
              </div>
      ...
      <section className="bg-sky-50 flex justify-center items-center px-6 py-12 md:py-24">
        <div className="mx-auto flex flex-1 flex-col max-w-6xl gap-12 md:gap-24">
          <div className="flex flex-col items-center md:text-center gap-6">
            <h1 className="text-3xl font-bold md:text-4xl">{t("my-serv-title")}</h1>
          ...
          <div className="flex flex-col-reverse gap-6 max-w-6xl md:flex md:flex-row-reverse">
            <div className="flex flex-col flex-1 items-start justify-center gap-6">
              <div className="flex flex-col gap-3">
                <h1 className="text-2xl font-bold text-center md:text-3xl md:text-start">{t("service-1-title")}</h1>
                <p className="text-md md:text-lg leading-relaxed">
                  {t("service-1-desc")}
                </p>
              </div>
              <div className="flex flex-col gap-3">
                <h3 className="text-xl font-bold text-start md:text-2xl">{t("service-1-ol-title")}</h3>
                <p className="text-md md:text-lg">{t("service-1-li-1")}</p>
                <p className="text-md md:text-lg">{t("service-1-li-2")}</p>
                <p className="text-md md:text-lg">{t("service-1-li-3")}</p>
                <p className="text-md md:text-lg">{t("service-1-li-4")}</p>
          ...
          <div className="flex flex-col-reverse gap-6 max-w-6xl md:flex md:flex-row">
            <div className="flex flex-col flex-1 items-start justify-center gap-6">
              <div className="flex flex-col gap-3">
                <h1 className="text-2xl font-bold text-center md:text-3xl md:text-start">{t("service-2-title")}</h1>
                <p className="text-md md:text-lg leading-relaxed">
                  {t("service-2-desc")}
                </p>
              </div>
              <div className="flex flex-col gap-3">
                <h3 className="text-xl font-bold text-start md:text-2xl">{t("service-2-ol-title")}</h3>
                <p className="text-md md:text-lg">{t("service-2-li-1")}</p>
                <p className="text-md md:text-lg">{t("service-2-li-2")}n</p>
                <p className="text-md md:text-lg">{t("service-2-li-3")}</p>
                <p className="text-md md:text-lg">{t("service-2-li-4")}</p>
          ...
          <div className="flex flex-col-reverse gap-6 max-w-6xl md:flex md:flex-row-reverse">
            <div className="flex flex-col flex-1 items-start justify-center gap-6">
              <div className="flex flex-col gap-3">
                <h1 className="text-2xl font-bold text-center md:text-3xl md:text-start">{t("service-3-title")}</h1>
                <p className="text-md md:text-lg leading-relaxed">
                  {t("service-3-desc")}
                </p>
              </div>
              <div className="flex flex-col gap-3">
                <h3 className="text-xl font-bold text-start md:text-2xl">{t("service-3-ol-title")}</h3>
                <p className="text-md md:text-lg">{t("service-3-li-1")}</p>
                <p className="text-md md:text-lg">{t("service-3-li-2")}</p>
                <p className="text-md md:text-lg">{t("service-3-li-3")}</p>
                <p className="text-md md:text-lg">{t("service-3-li-4")}</p>
      ...
      <section className="bg-gradient-to-b from-slate-800 via-slate-900 to-black flex justify-center text-white items-center px-6 py-12 md:py-24">
        <div className="max-w-6xl flex flex-col gap-12 md:gap-20">
          <h1 className="text-3xl font-bold text-center md:text-4xl">{t("wwyg-title")}</h1>
