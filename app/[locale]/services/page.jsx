          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="
            group p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl hover:bg-white/10 transition
          "
              >
                <div className="flex flex-col gap-6 items-start">
                  ...
                  <div
                    className="
                p-4 rounded-xl bg-emerald-500/10 text-emerald-400
              "
                  >
                    {/* CARD 1 — Clarity & Technical Direction */}
                    {i === 1 && (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="32"
                      ...
                      >
                        ...
                        <path d="M16 8l-3.5 7L8 16l1-4z" />
                      </svg>
                    )}

                    {/* CARD 2 — Time & Cost Efficiency */}
                    {i === 2 && (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="32"
                    ...
                    {/* CARD 3 — Scalable & Productive Systems */}
                    {i === 3 && (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="32"
