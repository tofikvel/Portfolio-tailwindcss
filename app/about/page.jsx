...
export default function AboutPage() {
  return (
    <main>
      <section className="flex flex-col-reverse items-center gap-8 px-6 py-12 mx-auto md:flex md:flex-row max-w-6xl border border-black">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-md text-gray-60 break-normal">
