...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-950 text-white px-6 py-12">
      <div className="max-w-7xl mx-auto flex flex-col items-center gap-12 py-6 mb-4 md:flex-row md:justify-between">
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <div className="flex flex-row items-center gap-4">
              ...
              <p className="text-lg">
                Münchener Straße 42A, 10779 Berlin, Germany
              </p>
            </div>
            <a
              href="https://www.linkedin.com/in/zeynalov23/"
        ...
        <div className="flex flex-row gap-20">
          <div className="flex flex-col space-y-4 md:flex md:flex-col md:space-y-6">
            <h3 className="font-bold text-xl text-bold">
              {t("navigation-title")}
            </h3>
