  ...
  return (
    <footer className="bg-[#1B1B1B] text-[#F9F9F9] px-6 py-12 border-t border-white/10">
      <div className="max-w-6xl mx-auto flex flex-col items-center gap-12 md:flex-row md:justify-between mb-12">
        ...
        "
              ...
              <div>
                ...
                <p className="text-md text-[#F9F9F9]">info@baque-solutions.com</p>
              </div>
            </div>
            {/* Address */}
            <div className="flex items-center gap-5">
        ...
        "
              ...
              <div className="">
                ...
                <p className="max-w-xs text-md leading-relaxed text-[#F9F9F9]">{t("footer-addess")}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-row gap-20">
          <div className="flex flex-col space-y-4 md:flex md:flex-col md:space-y-6">
            <h3 className="font-bold text-lg text-bold text-gray-400">{t("navigation-title")}</h3>
            <Link href="/" className="hover:text-gray-300 transition text-md">
              {t("home")}
            </Link>
            <Link href="/about" className="hover:text-gray-300 transition text-md">
              {t("about")}
            </Link>
            <Link href="/services" className="hover:text-gray-300 transition text-md">
              {t("services")}
            </Link>
            <Link href="/portfolio" className="hover:text-gray-300 transition text-md">
              {t("portfolio")}
            </Link>
          </div>
          <div className="flex flex-col space-y-4 md:flex md:flex-col md:space-y-6">
            <h3 className="font-bold text-lg text-bold text-gray-400">{t("help-title")}</h3>
            <Link href="/contact" className="hover:text-gray-300 transition text-md">
              {t("contact")}
            </Link>
            <Link href="/imprint" className="hover:text-gray-300 transition text-md">
              {t("imprint")}
            </Link>
            <Link href="/policy" className="hover:text-gray-300 transition text-md">
              {t("privacy-policy")}
            </Link>
          </div>
        </div>
      ...
      <div className="text-center">
        <p className="text-md text-gray-400">&copy; {copyRightDate} Baque Solutions. All Rights Reserved.</p>
      </div>
    </footer>
  );
}
